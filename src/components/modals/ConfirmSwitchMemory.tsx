...
const ConfirmSwitchMemory = ({ managerName }: { managerName: ManagerName | null }) => {
      ...
      <div className="modal-card">
        ...
        <section className="modal-card-body">
          <div className="content">
            Are you sure you want to switch memory management algorithms? The job queue and memory
